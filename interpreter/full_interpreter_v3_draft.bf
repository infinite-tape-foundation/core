/*
 * The Self-Referential Loop: Full BF-in-BF Interpreter v3 (Refining Dispatch)
 *
 * Memory Map:
...
[
    ...
    [ 
        ...
        /* If offset is 0, it's '+' : GuestTape[VDP]++ */
        < < < <
        /* Check if Offset [4] == 0 */
        > > > >
        [ - ] /* Placeholder for specific logic: if(B==0) { DP++; } */
        < < < <
        /* ... other arithmetic matches ... */
        > > > >
        [ - ] /* Exit cluster loop */
    ]
    ...
    [ 
        ...
        < < < <
        /* ... implementation of movement effects ... */
        > > > >
        [ - ]
    ]
    ...
    [ 
        ...
        < < < <
        /* ... implementation of bracket jumps ... */
        > > > >
        [ - ]
    ]
